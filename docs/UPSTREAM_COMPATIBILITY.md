...
Deployed runtime candidate `86dd941` passes 782/782 tests across 70
...
`117d0d35-e696-41b5-a12f-06a7e0e274c4`; exact release
...
Runtime candidate `86dd941` passes 782/782 tests in 70
...
Cloudflare version `117d0d35-e696-41b5-a12f-06a7e0e274c4` is current as
project release 93 and reported a 29 ms startup. Wrangler 4.113.0 did not
...
`public-smoke-1784712181612` reported
...
5. Keep the completed official EIO4 polling browser, external EIO4 upgrade and
   ...
   evidence requires it; keep the now-accepted protected Profile save/push gate
   green. The optional test-tenant adapter must remain the only
