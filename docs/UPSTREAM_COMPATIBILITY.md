...
The candidate Wrangler dry-run reports 250 Static Assets entries, 1319.52 KiB raw /
...
processed 250 Static Assets entries; the final dry run reported 1319.52 KiB raw
