...
Runtime candidate `329aaca` passes 785/785 tests in 71
...
Cloudflare version `1f7badbb-cdab-4031-8f55-f350c5277ae2` is current as
project release 94 and reported a 24 ms startup. Wrangler 4.113.0 did not
print a numeric Cloudflare ordinal. It processed 250 Static Assets entries; the
final dry run reported 1289.67 KiB raw / 237.03 KiB gzip, with only
...
The reusable credential-free remote smoke passed 150 assertions for health,
...
`public-smoke-1784713764749` reported
