...
`5574563d94df48177098cdbe0149ce953b771b9c` passes 638/638 tests across 56
...
`980637fd-9d51-433f-8fdd-5b1175fdc0fc`; exact release
...
The candidate Wrangler dry-run reports 248 official assets, 1153.77 KiB raw /
213.01 KiB gzip and only `ENTRY_STORE` plus `ASSETS`. Post-deployment API and
...
exclusions. Version 65 passed remote API/EIO4 and real-browser gates.
...
Runtime candidate
`5574563d94df48177098cdbe0149ce953b771b9c` passes 638/638 tests in 56
...
from sequential Wrangler history) is 100% active; its version was created at
`2026-07-20T10:11:34.774Z`, its deployment at
`2026-07-20T10:11:35.590Z`, and it reported a 25 ms startup. Wrangler 4.112.0
...
1153.77 KiB raw / 213.01 KiB gzip, with only `ENTRY_STORE` and `ASSETS`.
...
API3 Entries returned 401. Isolated tenant `public-smoke-1784542320857` reported
...
fresh tenant `public-smoke-1784542320857` and observed 237,568 SQLite bytes. It
...
A real Chromium session reloaded Cloudflare version 65, rendered the official homepage,
...
server mutation was attempted. The user's existing homepage tab was returned to
`/` and kept open. This is same-version evidence alongside version 65's remote
API and Engine.IO smoke.
