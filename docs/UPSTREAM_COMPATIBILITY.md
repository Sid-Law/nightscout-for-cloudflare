...
on top of request-local Basal Profile and Treatment Notify ports. Simple Alarms
...
The deployed version adds Simple Alarms and the core notification processor
while retaining Basal Profile, Treatment Notify, OpenAPS/Pump, IOB/COB and
treatment-to-curve,
